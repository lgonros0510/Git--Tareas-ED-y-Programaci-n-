 ...
 * empresa. Para ello, se pedirá por pantalla el número de personas en sala, su género
 * (siendo el 0 para los varones y el 1 para las mujeres) y el salario que posee cada
 * uno para, luego, mostrar la media del salario de cada género.
 */
...
public class Arrays10 {
    public static void main(String[] args) {
        ...
        System.out.print("Decidme el número de personas actuales de la sala:");
